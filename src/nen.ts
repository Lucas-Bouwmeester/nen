...
const affinities: Record<NenType, Record<NenType, number>> = {
...
let currentType: NenType | null = null;
...
const enhancementPercent =
    document.querySelector(".enhancement-percent")!;

const emissionPercent =
    document.querySelector(".emission-percent")!;

const transmutationPercent =
    document.querySelector(".transmutation-percent")!;

const manipulationPercent =
    document.querySelector(".manipulation-percent")!;

const conjurationPercent =
    document.querySelector(".conjuration-percent")!;

const specializationPercent =
    document.querySelector(".specialization-percent")!;
...
function updatePercentages(type: NenType) {
